...
android {
    ...
    defaultConfig {
        ...
        // alpha43-r35 preserves the frozen r34 functional baseline and adds generic Python
        // CLI launch configuration plus argv support across External and Internal Runtime paths.
        versionCode = 161
        versionName = "0.8.0-alpha43-r35"
