...
android {
    ...
    defaultConfig {
        ...
        // alpha43-r32 preserves r31 Runtime ownership and fixes Runtime Center live-output
        // churn: background snapshot reads, throttled in-place logs, stable scrolling and controls.
        versionCode = 158
        versionName = "0.8.0-alpha43-r32"
