...
internal object TermuxProjectActivityContract {
    fun wrap(
        ...
        return """
            ${hostPreamble}
            ${hostProcessHelpers}
            activity_pid_file="${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
...
}runtime_dir/$runtimeId.activity.${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            activity_pgid_file="${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            old_pid="${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
...
}(cat "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            old_pgid="${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            if siftalpha_pid_alive "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
...
}old_pid" || { [ -n "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
...
}old_pgid" ] && siftalpha_group_alive "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            rm -f -- "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            if command -v setsid >/dev/null 2>&1; then
              ...
              activity_pid=${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            wait "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            activity_code=${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
    ...
    """.trimIndent()
            ...
            exit "${'    private val gateway: V04ProjectGateway,
) : RuntimeCommandHost {
