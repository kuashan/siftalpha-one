...
class PythonRuntimeAdapterTest {
    ...
    fun `python logs keep procfs discovery authoritative and preserve the endpoint gate`() {
        ...
        assertTrue(script.contains("siftalpha_web_http_classify"))
        assertTrue(script.contains("SIFTALPHA_WEB_ENDPOINT_CLASS=HTML_UI"))
        assertTrue(script.contains("SIFTALPHA_WEB_ENDPOINT_CLASS=HTTP_FALLBACK"))
